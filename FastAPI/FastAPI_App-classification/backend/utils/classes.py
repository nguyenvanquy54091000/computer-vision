CALTECH_101_CLASSES = [
    ...
    "euphonium", "ewer", "ferry", "flamingo", "flamingo_head", "garfield",
    "gerenuk", "gramophone", "grand_piano", "hawksbill", "headphone",
    "hedgehog", "helicopter", "ibis", "inline_skate", "joshua_tree",
    ...
    "scissors", "scorpion", "seahorse", "snoopy", "soccer_ball", "stapler",
